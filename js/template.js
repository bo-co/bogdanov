...
$(document).ready(function() {	
	...
	aside.find("div.ui-resizable-handle > ul > li:first-child").on("mousedown touchstart", function() {
	...
	aside.find("div.ui-resizable-handle > ul > li:last-child").on("mousedown touchstart", function() {
		if (Math.round(aside.width()) >= asideWidth) {
			aside.animate({
